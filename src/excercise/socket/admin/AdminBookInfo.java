...
import excercise.socket.forAll.BookModel;
import excercise.socket.reader.ReaderDialog;
public class AdminBookInfo extends JPanel implements ActionListener
{
	...
	public AdminBookInfo()
	{
		...
		bk = new BookModel();
		String[] paras = {"1"};
		bk.query("select bookId,bookName,bookAuthor,bookPublicName,bookIntroduction,bookPublicDate, bookInOut from allbooks where 1=?", paras);
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		if(jb5==arg0.getSource())
		{
			...
			String[] paras = {"1"};
			String sql = "select bookId,bookName,bookAuthor,bookPublicName,bookIntroduction,bookPublicDate, bookInOut from allbooks where 1=?";
			bk = new BookModel();
			bk.query(sql, paras);
			jtable.setModel(bk);
		}
